package com.elice.practice.config.oauth;
...
import com.elice.practice.util.CookieUtil;
...
public class OAuth2SuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    public static final String REDIRECT_PATH = "/articles"; // 로그인 성공 후 리다이렉트 경로
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException {
        ...
        User user = userService.findByEmail((String) oAuth2User.getAttributes().get("email")); // 사용자 정보 조회
